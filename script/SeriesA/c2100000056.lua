...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- Special Summon 1 "Lycansquad" monster from your hand
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_LYCANSQUAD) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
