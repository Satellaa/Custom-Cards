...
function s.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()~=tp and Duel.GetCurrentPhase()&PHASE_MAIN1~=0
end
function s.spfilter(c,e,tp)
	return c:IsCode(888888881) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
...
function s.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		local pc=Duel.SelectMatchingCard(tp,Card.IsAbleToDeck,tp,LOCATION_HAND,0,1,1,nil)
		Duel.SendtoDeck(pc,nil,SEQ_DECKBOTTOM,REASON_EFFECT)
		end
	end
end