...
function s.ovfilter(c,tp,xyzc)
   return c:IsFaceup() and c:IsLevelAbove(8) and c:IsSetCard(0xf12,xyzc,SUMMON_TYPE_XYZ,tp) and (Duel.GetCurrentPhase()==PHASE_MAIN1 or PHASE_MAIN2) and not Duel.CheckPhaseActivity()
end
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xf12) and c:IsMonster() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
